...
<body>
    <h1 align='center' style="margin: 15px; color:black;font-weight: bold;font-family:'Times New Roman', Times, serif">XPRESS COURIER SERVICE</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:#273c75;font-family:'Times New Roman', Times, serif">A Reliable Courier Service </P>
    <div>
    ...
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                ...
                <p style="color:#273c75;">Please Fill Your Details ⮯⮯</p>
                <!-- <?php echo $error; ?> -->
