...
<head>
    ...
    <style>
        body
        {
        background-image:url('images/ftyvdutf.png');
...
<body>
    <h1 align='center' style="margin: 15px; color:#273c75;font-weight: bold;font-family:'Times New Roman', Times, serif">Reset Password</h1><hr/>
    <P align='center' style="font-weight: bold;color:black;font-family:'Times New Roman', Times, serif">A Reliable Courier Service</P>
        ...
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="color:#273c75;">To Reset Your Password⮯⮯</p>
                    <form action="resetpswd.php" method="get">
                        ...
                        <p style="color: #273c75;">Don't have an account?⮞➤ <a href="register.php">Register here</a>.</p>
